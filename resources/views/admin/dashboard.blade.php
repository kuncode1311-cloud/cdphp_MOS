...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .shell.sidebar-collapsed .brand span,
        ...
        .shell.sidebar-collapsed .group-title-wrap {
            justify-content: center;
        }
        ...
        .shell.sidebar-collapsed .nav-sub-item .sub-icon {
            font-size: 16px;
            margin: 0;
        }
        ...
        .shell.sidebar-collapsed .logout button span {
            font-size: 16px;
            margin: 0;
        }
        .brand {
        ...
        .admin-info b { display: block; font-size: 13.5px; font-weight: 850; color: #0f172a; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .admin-info small { display: block; color: #0284c7; font-size: 11.5px; font-weight: 750; margin-top: 2px; }

        /* Sidebar Accordion Grouping & Hierarchy */
        .sidebar-accordion {
            display: flex;
            flex-direction: column;
            gap: 8px;
        ...
        .nav-group:not(.open) .group-chevron {
            transform: rotate(-90deg);
        }

        /* Submenu & Sub-items with Clean Indentation */
        .nav-submenu {
            display: flex;
            flex-direction: column;
            gap: 3px;
        ...
        .nav-sub-item.on .sub-icon {
            opacity: 1;
            color: #ffffff;
        }

        .logout { margin-top: auto; flex-shrink: 0; padding-top: 12px; }
        .logout button {
            width: 100%;
            padding: 9px;
            background: #fff1f2;
