...
<style>
    /* =========================================================================
       ✨ TOPBAR STYLING - TONE SÁNG (SKY ICE PASTEL) THANH LỊCH, SANG TRỌNG & RÕ NÉT
       ========================================================================= */
    .admin-unified-topbar {
        ...
        height: 68px;
        padding: 0 24px;
        background: linear-gradient(90deg, #f0f7ff 0%, #e8f2fe 50%, #f1f8ff 100%);
        border-bottom: 2.5px solid #bfdbfe;
        box-shadow: 0 4px 16px rgba(15, 23, 42, 0.05), inset 0 -2px 0 rgba(59, 130, 246, 0.15);
        display: flex;
        align-items: center;
